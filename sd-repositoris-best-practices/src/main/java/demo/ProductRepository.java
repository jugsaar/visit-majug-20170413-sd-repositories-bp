...
public interface ProductRepository
		extends ReadOnlyRepository<Product>, ProductRepositoryCustom, ExtendedRepository<Product, Long> {
	 ...
	 * <li>via a {@code named-query} element in the
	 * <code>META-INF/orm.xml</code> file</li>
	 * </ol>
	 * 
	 * @param attribute
	 * @return
